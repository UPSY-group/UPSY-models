module calving_model_basic
  ...
  public :: atype_calving_model , type_calving_model_context_allocate ,&
  ...
  type, abstract, extends(atype_calving_model_data) :: atype_calving_model
    ...
    contains
      ...
      procedure(allocate_calving_model_ifc),   deferred :: allocate_calving_model
  ...
  type, extends(atype_model_context_allocate) :: type_calving_model_context_allocate
  end type type_calving_model_context_allocate
  ...
  abstract interface
    ...
    subroutine allocate_calving_model_ifc( self, context)
      import atype_calving_model, type_calving_model_context_allocate
      class(atype_calving_model),                        intent(inout) :: self
      type(type_calving_model_context_allocate), target, intent(in   ) :: context
    end subroutine allocate_calving_model_ifc
