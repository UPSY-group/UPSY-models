submodule(calving_model_basic) calving_model_initialise

contains

  function ct_initialise( ) result( context)
    !< Create a contect object for calving_model%initialise
  ...
  subroutine initialise_model_abs( self, context)
    ...
    ! Local variables:
    character(len=1024), parameter :: routine_name = 'atype_calving_model_initialise_model_abs'
    ...
    class default
      call crash('invalid context class; should be atype_calving_model_context_initialise')
    class is (type_calving_model_context_initialise)
  ...
  subroutine initialise_model( self, context)
    ...
    ! Local variables:
    character(len=1024), parameter :: routine_name = 'atype_calving_model_initialise_model'
    ...
    call self%initialise_calving_model( context)
...
end submodule calving_model_initialise