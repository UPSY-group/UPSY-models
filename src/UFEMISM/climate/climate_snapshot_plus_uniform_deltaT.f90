...
! =========================
  ...
  SUBROUTINE run_climate_model_snapshot_plus_uniform_deltaT( mesh, geom, climate, time)
    ...
    call apply_geometry_downscaling_corrections( mesh, geom, climate, climate%snapshot_unif_dT%snapshot, climate%snapshot_unif_dT%deltaT)
  ...
  SUBROUTINE initialise_climate_model_snapshot_plus_uniform_deltaT( mesh, geom, climate, region_name)
  ...
  SUBROUTINE remap_climate_snapshot_plus_uniform_deltaT( mesh_old, mesh_new, geom, climate, region_name)
  ! In/out variables
    ...
    call apply_geometry_downscaling_corrections( mesh_new, geom, climate, climate%snapshot_unif_dT%snapshot, climate%snapshot_unif_dT%deltaT)
