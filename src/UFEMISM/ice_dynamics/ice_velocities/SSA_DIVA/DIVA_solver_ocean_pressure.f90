...
contains
  ...
  subroutine solve_DIVA_ocean_pressure( mesh, ice, geom, bed_roughness, DIVA, n_visc_its, n_Axb_its, &
    ...
    viscosity_iteration: do while (.not. has_converged)
      ...
      call calc_effective_viscosity( mesh, ice, geom, DIVA%DIVA_graphs, Glens_flow_law_epsilon_sq_0_applied)
  ...
  subroutine allocate_DIVA_solver_on_graphs( mesh, DIVA)
    ...
    ! Solution
    call allocate_dist_shared( DIVA%u_vav_b                     , DIVA%wu_vav_b                     , [DIVA%graphs%graph_b%pai%i1_nih, DIVA%graphs%graph_b%pai%i2_nih])
    call allocate_dist_shared( DIVA%v_vav_b                     , DIVA%wv_vav_b                     , [DIVA%graphs%graph_b%pai%i1_nih, DIVA%graphs%graph_b%pai%i2_nih])
    call allocate_dist_shared( DIVA%u_base_b                    , DIVA%wu_base_b                    , [DIVA%graphs%graph_b%pai%i1_nih, DIVA%graphs%graph_b%pai%i2_nih])
    call allocate_dist_shared( DIVA%v_base_b                    , DIVA%wv_base_b                    , [DIVA%graphs%graph_b%pai%i1_nih, DIVA%graphs%graph_b%pai%i2_nih])
    call allocate_dist_shared( DIVA%u_3D_b                      , DIVA%wu_3D_b                      , [DIVA%graphs%graph_b%pai%i1_nih, DIVA%graphs%graph_b%pai%i2_nih], [1, mesh%nz])
    call allocate_dist_shared( DIVA%v_3D_b                      , DIVA%wv_3D_b                      , [DIVA%graphs%graph_b%pai%i1_nih, DIVA%graphs%graph_b%pai%i2_nih], [1, mesh%nz])

    ! Intermediate data fields
    call allocate_dist_shared( DIVA%du_dx_a                     , DIVA%wdu_dx_a                     , [DIVA%graphs%graph_a%pai%i1_nih, DIVA%graphs%graph_a%pai%i2_nih])
    call allocate_dist_shared( DIVA%du_dy_a                     , DIVA%wdu_dy_a                     , [DIVA%graphs%graph_a%pai%i1_nih, DIVA%graphs%graph_a%pai%i2_nih])
    call allocate_dist_shared( DIVA%dv_dx_a                     , DIVA%wdv_dx_a                     , [DIVA%graphs%graph_a%pai%i1_nih, DIVA%graphs%graph_a%pai%i2_nih])
    call allocate_dist_shared( DIVA%dv_dy_a                     , DIVA%wdv_dy_a                     , [DIVA%graphs%graph_a%pai%i1_nih, DIVA%graphs%graph_a%pai%i2_nih])
    call allocate_dist_shared( DIVA%du_dx_b                     , DIVA%wdu_dx_b                     , [DIVA%graphs%graph_b%pai%i1_nih, DIVA%graphs%graph_b%pai%i2_nih])
    call allocate_dist_shared( DIVA%du_dy_b                     , DIVA%wdu_dy_b                     , [DIVA%graphs%graph_b%pai%i1_nih, DIVA%graphs%graph_b%pai%i2_nih])
    call allocate_dist_shared( DIVA%dv_dx_b                     , DIVA%wdv_dx_b                     , [DIVA%graphs%graph_b%pai%i1_nih, DIVA%graphs%graph_b%pai%i2_nih])
    call allocate_dist_shared( DIVA%dv_dy_b                     , DIVA%wdv_dy_b                     , [DIVA%graphs%graph_b%pai%i1_nih, DIVA%graphs%graph_b%pai%i2_nih])
    call allocate_dist_shared( DIVA%du_dz_3D_a                  , DIVA%wdu_dz_3D_a                  , [DIVA%graphs%graph_a%pai%i1_nih, DIVA%graphs%graph_a%pai%i2_nih], [1, mesh%nz])
    call allocate_dist_shared( DIVA%dv_dz_3D_a                  , DIVA%wdv_dz_3D_a                  , [DIVA%graphs%graph_a%pai%i1_nih, DIVA%graphs%graph_a%pai%i2_nih], [1, mesh%nz])
    call allocate_dist_shared( DIVA%du_dz_3D_b                  , DIVA%wdu_dz_3D_b                  , [DIVA%graphs%graph_b%pai%i1_nih, DIVA%graphs%graph_b%pai%i2_nih], [1, mesh%nz])
    call allocate_dist_shared( DIVA%dv_dz_3D_b                  , DIVA%wdv_dz_3D_b                  , [DIVA%graphs%graph_b%pai%i1_nih, DIVA%graphs%graph_b%pai%i2_nih], [1, mesh%nz])
    call allocate_dist_shared( DIVA%eta_3D_a                    , DIVA%weta_3D_a                    , [DIVA%graphs%graph_a%pai%i1_nih, DIVA%graphs%graph_a%pai%i2_nih], [1, mesh%nz])
    call allocate_dist_shared( DIVA%eta_3D_b                    , DIVA%weta_3D_b                    , [DIVA%graphs%graph_b%pai%i1_nih, DIVA%graphs%graph_b%pai%i2_nih], [1, mesh%nz])
    call allocate_dist_shared( DIVA%eta_vav_a                   , DIVA%weta_vav_a                   , [DIVA%graphs%graph_a%pai%i1_nih, DIVA%graphs%graph_a%pai%i2_nih])
    call allocate_dist_shared( DIVA%eta_vav_b                   , DIVA%weta_vav_b                   , [DIVA%graphs%graph_b%pai%i1_nih, DIVA%graphs%graph_b%pai%i2_nih])
    call allocate_dist_shared( DIVA%N_a                         , DIVA%wN_a                         , [DIVA%graphs%graph_a%pai%i1_nih, DIVA%graphs%graph_a%pai%i2_nih])
    call allocate_dist_shared( DIVA%N_b                         , DIVA%wN_b                         , [DIVA%graphs%graph_b%pai%i1_nih, DIVA%graphs%graph_b%pai%i2_nih])
    call allocate_dist_shared( DIVA%dN_dx_b                     , DIVA%wdN_dx_b                     , [DIVA%graphs%graph_b%pai%i1_nih, DIVA%graphs%graph_b%pai%i2_nih])
    call allocate_dist_shared( DIVA%dN_dy_b                     , DIVA%wdN_dy_b                     , [DIVA%graphs%graph_b%pai%i1_nih, DIVA%graphs%graph_b%pai%i2_nih])
    call allocate_dist_shared( DIVA%F1_3D_a                     , DIVA%wF1_3D_a                     , [DIVA%graphs%graph_a%pai%i1_nih, DIVA%graphs%graph_a%pai%i2_nih], [1, mesh%nz])
    call allocate_dist_shared( DIVA%F2_3D_a                     , DIVA%wF2_3D_a                     , [DIVA%graphs%graph_a%pai%i1_nih, DIVA%graphs%graph_a%pai%i2_nih], [1, mesh%nz])
    call allocate_dist_shared( DIVA%F1_3D_b                     , DIVA%wF1_3D_b                     , [DIVA%graphs%graph_b%pai%i1_nih, DIVA%graphs%graph_b%pai%i2_nih], [1, mesh%nz])
    call allocate_dist_shared( DIVA%F2_3D_b                     , DIVA%wF2_3D_b                     , [DIVA%graphs%graph_b%pai%i1_nih, DIVA%graphs%graph_b%pai%i2_nih], [1, mesh%nz])
    call allocate_dist_shared( DIVA%basal_friction_coefficient_b, DIVA%wbasal_friction_coefficient_b, [DIVA%graphs%graph_b%pai%i1_nih, DIVA%graphs%graph_b%pai%i2_nih])
    call allocate_dist_shared( DIVA%beta_eff_a                  , DIVA%wbeta_eff_a                  , [DIVA%graphs%graph_a%pai%i1_nih, DIVA%graphs%graph_a%pai%i2_nih])
    call allocate_dist_shared( DIVA%beta_eff_b                  , DIVA%wbeta_eff_b                  , [DIVA%graphs%graph_b%pai%i1_nih, DIVA%graphs%graph_b%pai%i2_nih])
    call allocate_dist_shared( DIVA%tau_bx_b                    , DIVA%wtau_bx_b                    , [DIVA%graphs%graph_b%pai%i1_nih, DIVA%graphs%graph_b%pai%i2_nih])
    call allocate_dist_shared( DIVA%tau_by_b                    , DIVA%wtau_by_b                    , [DIVA%graphs%graph_b%pai%i1_nih, DIVA%graphs%graph_b%pai%i2_nih])
    call allocate_dist_shared( DIVA%tau_dx_b                    , DIVA%wtau_dx_b                    , [DIVA%graphs%graph_b%pai%i1_nih, DIVA%graphs%graph_b%pai%i2_nih])
    call allocate_dist_shared( DIVA%tau_dy_b                    , DIVA%wtau_dy_b                    , [DIVA%graphs%graph_b%pai%i1_nih, DIVA%graphs%graph_b%pai%i2_nih])
    call allocate_dist_shared( DIVA%tau_ox_b                    , DIVA%wtau_ox_b                    , [DIVA%graphs%graph_b%pai%i1_nih, DIVA%graphs%graph_b%pai%i2_nih])
    call allocate_dist_shared( DIVA%tau_oy_b                    , DIVA%wtau_oy_b                    , [DIVA%graphs%graph_b%pai%i1_nih, DIVA%graphs%graph_b%pai%i2_nih])
    call allocate_dist_shared( DIVA%u_b_prev                    , DIVA%wu_b_prev                    , [DIVA%graphs%graph_b%pai%i1_nih, DIVA%graphs%graph_b%pai%i2_nih])
    call allocate_dist_shared( DIVA%v_b_prev                    , DIVA%wv_b_prev                    , [DIVA%graphs%graph_b%pai%i1_nih, DIVA%graphs%graph_b%pai%i2_nih])
  ...
  subroutine calc_driving_stress( DIVA)
    ...
    call allocate_dist_shared( Hi_b    , wHi_b    , [DIVA%graphs%graph_b%pai%i1_nih, DIVA%graphs%graph_b%pai%i2_nih])
    call allocate_dist_shared( dHs_dx_b, wdHs_dx_b, [DIVA%graphs%graph_b%pai%i1_nih, DIVA%graphs%graph_b%pai%i2_nih])
    call allocate_dist_shared( dHs_dy_b, wdHs_dy_b, [DIVA%graphs%graph_b%pai%i1_nih, DIVA%graphs%graph_b%pai%i2_nih])
  ...
  subroutine calc_ocean_back_pressure( DIVA)
    ...
    ! Allocate hybrid distributed/shared memory
    call allocate_dist_shared( Hi_b, wHi_b, [DIVA%graphs%graph_b%pai%i1_nih, DIVA%graphs%graph_b%pai%i2_nih])
    call allocate_dist_shared( Ho_b, wHo_b, [DIVA%graphs%graph_b%pai%i1_nih, DIVA%graphs%graph_b%pai%i2_nih])
  ...
  subroutine calc_effective_viscosity( mesh, ice, geom, DIVA, Glens_flow_law_epsilon_sq_0_applied)
    ...
    ! Allocate hybrid distributed/shared memory
    call allocate_dist_shared( Hi_b       , wHi_b       , [DIVA%graphs%graph_b%pai%i1_nih, DIVA%graphs%graph_b%pai%i2_nih])
    call allocate_dist_shared( A_flow_3D_b, wA_flow_3D_b, [DIVA%graphs%graph_b%pai%i1_nih, DIVA%graphs%graph_b%pai%i2_nih], [1, mesh%nz])
  ...
  subroutine calc_effective_basal_friction_coefficient( mesh, ice, geom, bed_roughness, DIVA)
    ...
    ! Allocate hybrid distributed/shared memory
    call allocate_dist_shared( u_base_a, wu_base_a, [DIVA%graphs%graph_a%pai%i1_nih, DIVA%graphs%graph_a%pai%i2_nih])
    call allocate_dist_shared( v_base_a, wv_base_a, [DIVA%graphs%graph_a%pai%i1_nih, DIVA%graphs%graph_a%pai%i2_nih])
