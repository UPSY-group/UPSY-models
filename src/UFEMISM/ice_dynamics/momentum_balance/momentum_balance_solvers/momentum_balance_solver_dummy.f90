...
contains
  ...
  subroutine momentum_balance_solver_dummy_allocate( self, region_name, mesh)
  ...
  subroutine momentum_balance_solver_dummy_deallocate( self)
    ...
    ! Deallocate all the stuff that is specific to the dummy momentum balance solver
  ...
  subroutine momentum_balance_solver_dummy_initialise( self)
    ...
    ! Initialise all the stuff that is specific to the dummy momentum balance solver
  ...
  subroutine momentum_balance_solver_dummy_run( self, ice, geom, bed_roughness, &
    ...
    ! Run all the stuff that is specific to the dummy momentum balance solver
  ...
  subroutine momentum_balance_solver_dummy_remap( self, mesh_old, mesh_new)
    ...
    ! Remap all the stuff that is specific to the dummy momentum balance solver
