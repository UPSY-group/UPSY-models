module momentum_balance_solver_plain_BPA
  ...
  public :: type_momentum_balance_solver_plain_BPA

  type, extends(atype_momentum_balance_solver_plain) :: type_momentum_balance_solver_plain_BPA
    ...
    contains
      ...
      procedure, public :: allocate_momentum_balance_solver_plain   => momentum_balance_solver_plain_BPA_allocate
      procedure, public :: deallocate_momentum_balance_solver_plain => momentum_balance_solver_plain_BPA_deallocate
      procedure, public :: initialise_momentum_balance_solver_plain => momentum_balance_solver_plain_BPA_initialise
      procedure, public :: run_momentum_balance_solver_plain        => momentum_balance_solver_plain_BPA_run
      procedure, public :: remap_momentum_balance_solver_plain      => momentum_balance_solver_plain_BPA_remap
  ...
  end type type_momentum_balance_solver_plain_BPA

contains

! == Main routines

  subroutine momentum_balance_solver_plain_BPA_allocate( self)

    ! In/output variables:
    class(type_momentum_balance_solver_plain_BPA), intent(inout) :: self

    ! Local variables:
    character(len=*), parameter :: routine_name = 'momentum_balance_solver_plain_BPA_allocate'
  ...
  end subroutine momentum_balance_solver_plain_BPA_allocate

  subroutine momentum_balance_solver_plain_BPA_deallocate( self)

    ! In/output variables:
    class(type_momentum_balance_solver_plain_BPA), intent(inout) :: self

    ! Local variables:
    character(len=*), parameter :: routine_name = 'momentum_balance_solver_plain_BPA_deallocate'
  ...
  end subroutine momentum_balance_solver_plain_BPA_deallocate

  subroutine momentum_balance_solver_plain_BPA_initialise( self)

    ! In/output variables:
    class(type_momentum_balance_solver_plain_BPA), intent(inout) :: self

    ! Local variables:
    character(len=*), parameter   :: routine_name = 'momentum_balance_solver_plain_BPA_initialise'
  ...
  end subroutine momentum_balance_solver_plain_BPA_initialise
  ...
  subroutine momentum_balance_solver_plain_BPA_run( self, ice, geom, bed_roughness, &
    ...
    ! Local variables:
    character(len=*), parameter           :: routine_name = 'momentum_balance_solver_plain_BPA_run'
    integer                               :: ierr
  ...
  end subroutine momentum_balance_solver_plain_BPA_run

  subroutine momentum_balance_solver_plain_BPA_remap( self, mesh_old, mesh_new)
    ...
    ! Local variables:
    character(len=*), parameter           :: routine_name = 'momentum_balance_solver_plain_BPA_remap'
  ...
  end subroutine momentum_balance_solver_plain_BPA_remap

  function get_momentum_balance_solver_plain_name( self) result( model_name)
    class(type_momentum_balance_solver_plain_BPA), intent(in) :: self
