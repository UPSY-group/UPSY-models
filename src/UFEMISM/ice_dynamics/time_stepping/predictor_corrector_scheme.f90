...
contains
  ...
  subroutine run_ice_dynamics_model_pc( region, dt_max)
    ...
    iterate_pc_timestep: do while (pc_it < C%pc_nit_max)
      ...
      call calc_dHi_dt( region%mesh, region%ice, region%ice%geom%Hi, region%ice%geom%Hb, region%ice%SL, region%ice%u_vav_b, region%ice%v_vav_b, SMB_loc, region%BMB%BMB, region%LMB%LMB, region%AMB%AMB, region%ice%fraction_margin, &
      ...
      call alter_ice_thickness( region%mesh, region%ice, region%ice%Hi_prev, region%ice%geom%Hb, region%ice%SL, region%ice%pc%Hi_star_np1, region%refgeo_PD, region%time)
      ...
      call alter_ice_thickness( region%mesh, region%ice, region%ice%Hi_prev, region%ice%geom%Hb, region%ice%SL, region%ice%pc%Hi_np1, region%refgeo_PD, region%time)
