...
contains
  ...
  subroutine create_main_regional_output_file_mesh_field( filename, ncid, choice_output_field)
    ...
    ! =====================
      ...
      case("basal_hydro_D")
        call add_field_mesh_dp_2D_b( filename, ncid, 'basal_hydro_D', precision = C%output_precision, do_compress = C%do_compress_output, long_name = 'Subglacial water diffusivity', units = 'm^2 yr^-1')
      case("basal_hydro_K")
        call add_field_mesh_dp_2D_b( filename, ncid, 'basal_hydro_K', precision = C%output_precision, do_compress = C%do_compress_output, long_name = 'Subglacial water effective conductivity', units = 'm yr^-1')
      case("basal_hydro_P")
