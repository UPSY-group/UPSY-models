    ...
    ! =================
      ...
      case ('mask_margin')
        do vi = region%mesh%vi1, region%mesh%vi2
          if (region%ice%geom%mask_margin( vi)) then
            mask_int( vi) = 1
          else
            mask_int( vi) = 0
          end if
      ...
      case ('mask_gl_gr')
        do vi = region%mesh%vi1, region%mesh%vi2
          if (region%ice%geom%mask_gl_gr( vi)) then
            mask_int( vi) = 1
          else
            mask_int( vi) = 0
          end if
      ...
      case ('mask_cf_gr')
        do vi = region%mesh%vi1, region%mesh%vi2
          if (region%ice%geom%mask_cf_gr( vi)) then
            mask_int( vi) = 1
          else
            mask_int( vi) = 0
          end if
      ...
      case ('mask_cf_fl')
        do vi = region%mesh%vi1, region%mesh%vi2
          if (region%ice%geom%mask_cf_fl( vi)) then
            mask_int( vi) = 1
          else
            mask_int( vi) = 0
          end if
      ...
      case ('mask_coastline')
        do vi = region%mesh%vi1, region%mesh%vi2
          if (region%ice%geom%mask_coastline( vi)) then
            mask_int( vi) = 1
          else
            mask_int( vi) = 0
          end if
