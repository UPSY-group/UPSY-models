...
contains
  ...
  subroutine write_to_main_regional_output_file_mesh_field( region, filename, ncid, choice_output_field)
    ...
    ! =====================
      ...
      case("basal_hydro_D")
        call write_to_field_multopt_mesh_dp_2D( region%mesh, filename, ncid, 'basal_hydro_D', region%ice%hydro_Salle2025%D_b)
      case("basal_hydro_K")
        call write_to_field_multopt_mesh_dp_2D( region%mesh, filename, ncid, 'basal_hydro_K', region%ice%hydro_Salle2025%K_b)
      case("basal_hydro_P")
  ...
  subroutine create_main_regional_output_file_mesh_field( filename, ncid, choice_output_field)
    ...
    ! =====================
      ...
      case("basal_hydro_u")
        call add_field_mesh_dp_2D( filename, ncid, 'basal_hydro_u', precision = C%output_precision, do_compress = C%do_compress_output, long_name = 'Subglacial water velocity x-direction', units = 'm yr^-1')
      case("basal_hydro_v")
        call add_field_mesh_dp_2D( filename, ncid, 'basal_hydro_v', precision = C%output_precision, do_compress = C%do_compress_output, long_name = 'Subglacial water velocity y-direction', units = 'm yr^-1')
      case("basal_hydro_ub")
      ...
      case("basal_hydro_K")
        call add_field_mesh_dp_2D( filename, ncid, 'basal_hydro_K', precision = C%output_precision, do_compress = C%do_compress_output, long_name = 'Subglacial water effective conductivity', units = 'm yr^-1')
      case("basal_hydro_P")
      ...
      case("basal_hydro_O")
        call add_field_mesh_dp_2D( filename, ncid, 'basal_hydro_O', precision = C%output_precision, do_compress = C%do_compress_output, long_name = 'Cavity opening rate', units = 'm yr^-1')
      case("basal_hydro_C")
        call add_field_mesh_dp_2D( filename, ncid, 'basal_hydro_C', precision = C%output_precision, do_compress = C%do_compress_output, long_name = 'Cavity closing rate', units = 'm yr^-1')
