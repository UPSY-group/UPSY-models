...
contains
  ...
  subroutine SMB_model_snp_p_anml_initialise( self, ice, refgeo_init, refgeo_PD, region_name)
    ...
    ! Local variables:
    character(len=1024), parameter :: routine_name = 'SMB_model_snp_p_anml_initialise'
