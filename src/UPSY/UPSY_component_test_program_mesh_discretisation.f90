program UPSY_component_test_program_mesh_discretisation
  ...
  if (iargc() == 2) then
    ...
    call getarg( 2, foldername_output)                 ! path/to/UPSY-models/automated_testing/component_test_mesh_discretisation/results
