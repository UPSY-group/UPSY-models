program UPSY_component_test_program_mesh_remapping_grid_grid
...
#include <petsc/finclude/petscsys.h>
  ...
  use ct_remapping_grid_to_grid, only: run_all_grid_to_grid_remapping_tests
  ...
  program_name = 'UPSY_component_test_mesh_remapping_grid_grid'
  ...
  if (iargc() == 2) then
    ...
    call getarg( 2, foldername_output)                 ! path/to/UPSY-models/automated_testing/component_test_mesh_remapping_grid_grid/results
  ...
  call run_all_grid_to_grid_remapping_tests( foldername_output, test_grid_filenames)
