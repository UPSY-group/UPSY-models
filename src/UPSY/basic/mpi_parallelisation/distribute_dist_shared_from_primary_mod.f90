...
contains
  ...
  subroutine distribute_dist_shared_from_primary_complex_1D( pai, d_nih, d_tot)
    ...
    ! In/output variables:
    type(type_par_arr_info),                               intent(in   ) :: pai
    complex(dp), dimension(pai%i1_nih:pai%i2_nih), target, intent(  out) :: d_nih
    complex(dp), dimension(1:pai%n), optional, target,     intent(in   ) :: d_tot
  ...
  subroutine distribute_dist_shared_from_primary_complex_2D( pai, nz, d_nih, d_tot)
    ...
    type(type_par_arr_info),                                    intent(in   ) :: pai
    integer,                                                    intent(in   ) :: nz
    complex(dp), dimension(pai%i1_nih:pai%i2_nih,1:nz), target, intent(  out) :: d_nih
    complex(dp), dimension(1:pai%n,1:nz), optional, target,     intent(in   ) :: d_tot
  ...
  subroutine distribute_dist_shared_from_primary_complex_3D( pai, nz, nl, d_nih, d_tot)
    ...
    type(type_par_arr_info),                                         intent(in   ) :: pai
    integer,                                                         intent(in   ) :: nz, nl
    complex(dp), dimension(pai%i1_nih:pai%i2_nih,1:nz,1:nl), target, intent(  out) :: d_nih
    complex(dp), dimension(1:pai%n,1:nz,1:nl), optional, target,     intent(in   ) :: d_tot
