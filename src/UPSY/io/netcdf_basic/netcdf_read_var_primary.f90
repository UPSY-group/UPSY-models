module netcdf_read_var_primary
  ...
  interface read_var_primary
    ...
    procedure read_var_primary_int64_0D
    procedure read_var_primary_int64_1D
    procedure read_var_primary_int64_2D
    procedure read_var_primary_int64_3D
    procedure read_var_primary_int64_4D
...
subroutine read_var_primary_int64_0D(  filename, ncid, id_var, d)
  ...
  integer,          intent(in   ) :: ncid
  integer,          intent(in   ) :: id_var
  integer(int8),    intent(  out) :: d

  ! Local variables:
  character(len=1024), parameter :: routine_name = 'read_var_primary_int64_0D'
  character(len=1024)            :: var_name
  integer                        :: var_type
  integer                        :: ndims_of_var
  ...
  ! Check variable type
  if (.not. (var_type == NF90_INT64)) &
    call crash('variable "' // trim( var_name) // '" in file "' // trim( filename) // '" is not of type NF90_INT64!')
...
end subroutine read_var_primary_int64_0D

subroutine read_var_primary_int64_1D( filename, ncid, id_var, d, start, count)
  ! Read data from a NetCDF file
  !
  ! NOTE: only the primary actually reads data! Distributing to other processes
  !       must be done afterward
  ...
  integer,                          intent(in   ) :: ncid
  integer,                          intent(in   ) :: id_var
  integer(int8), dimension(:),      intent(  out) :: d
  integer,  dimension(1), optional, intent(in   ) :: start, count

  ! Local variables:
  character(len=1024), parameter          :: routine_name = 'read_var_primary_int64_1D'
  character(len=1024)                     :: var_name
  integer                                 :: var_type
  integer                                 :: ndims_of_var
  integer,  dimension( NF90_MAX_VAR_DIMS) :: dims_of_var
...
end subroutine read_var_primary_int64_1D

subroutine read_var_primary_int64_2D( filename, ncid, id_var, d, start, count)
  ! Read data from a NetCDF file
  !
  ! NOTE: only the primary actually reads data! Distributing to other processes
  !       must be done afterward
  ...
  ! Local variables:
  character(len=1024), parameter          :: routine_name = 'read_var_primary_int64_2D'
  character(len=1024)                     :: var_name
  integer                                 :: var_type
  integer                                 :: ndims_of_var
  integer,  dimension( NF90_MAX_VAR_DIMS) :: dims_of_var
...
end subroutine read_var_primary_int64_2D

subroutine read_var_primary_int64_3D( filename, ncid, id_var, d, start, count)
  ! Read data from a NetCDF file
  !
  ! NOTE: only the primary actually reads data! Distributing to other processes
  !       must be done afterward
  ...
  ! Local variables:
  character(len=1024), parameter          :: routine_name = 'read_var_primary_int64_3D'
  character(len=1024)                     :: var_name
  integer                                 :: var_type
  integer                                 :: ndims_of_var
  integer,  dimension( NF90_MAX_VAR_DIMS) :: dims_of_var
...
end subroutine read_var_primary_int64_3D

subroutine read_var_primary_int64_4D( filename, ncid, id_var, d, start, count)
  ! Read data from a NetCDF file
  !
  ! NOTE: only the primary actually reads data! Distributing to other processes
  !       must be done afterward
  ...
  ! Local variables:
  character(len=1024), parameter          :: routine_name = 'read_var_primary_int64_4D'
  character(len=1024)                     :: var_name
  integer                                 :: var_type
  integer                                 :: ndims_of_var
  integer,  dimension( NF90_MAX_VAR_DIMS) :: dims_of_var
...
end subroutine read_var_primary_int64_4D
