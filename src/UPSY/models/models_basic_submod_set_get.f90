...
contains
  ...
  function is_region_name( self, region_name) result( res)
    ...
    character(len=*),   intent(in) :: region_name
    logical                        :: res
    res = trim( self%region_name_val) == trim( region_name)
